...
#write.csv(clim.base, file = "data/clim_base.csv", row.names = F)
#write.csv(clim.remper, file = "data/clim_remper.csv", row.names = F)
#write.csv(clim.recent, file = "data/clim_recent.csv", row.names = F)
...
clim.base <- read.csv("data/clim_base.csv", header=T, stringsAsFactors=F)
clim.remper <- read.csv("data/clim_remper.csv",header=T,stringsAsFactors=F)
clim.recent <- read.csv("data/clim_recent.csv",header=T,stringsAsFactors=F)
