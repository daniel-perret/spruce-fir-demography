...
```{r}
ind.mort.dat <- read.csv("data/mortdat_forDryad.csv",header=T) # for survival model
seed.dat <- read.csv("data/seeddat_forDryad.csv",header=T) # for regeneration model
sap.dat <- read.csv("data/sapdat_forDryad.csv",header=T) # for recruitment model
```
...
traj.dat <- traj.dat %>% bind_cols(new_data(try, 
                                            terms=
