...
```{r}
ind.mort.dat <- read.csv("mortdat_forDryad.csv",header=T) # for survival model
seed.dat <- read.csv("seeddat_forDryad.csv",header=T) # for regeneration model
sap.dat <- read.csv("sapdat_forDryad.csv",header=T) # for recruitment model
```
